...
class Product(models.Model):
    ...
    category = models.CharField(max_length = 255, default="apparel")
    type = models.CharField(max_length=255, default="shirt")
    target = models.CharField(max_length=255, default="mens")
